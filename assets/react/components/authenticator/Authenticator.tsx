...
export default function Authenticator() {
    ...
    return (
        <div className="w-[60%] p-2 h-[70%] place-content-center z-[100] rounded-lg bg-white text-white gap-2 flex flex-col items-center justify-around hover:brightness-95">
