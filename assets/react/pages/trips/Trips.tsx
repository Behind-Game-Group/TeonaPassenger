...
function Trips() {
    ...
    return (
        <div className='flex flex-col items-center justify-around'>
            <div>
                ...
                <section className='flex flex-col items-center justify-around gap-4'>
                    ...
                    <div className="flex items-center gap-4">
                        <label htmlFor="isConsultableOption1">Toutes les personnes disposant du lien</label>
                        <input
                            type="radio"
                            name="choice"
                        ...
                        <label htmlFor="isConsultableOption2">Seulement les personnes que vous invitez par e-mail</label>
                        <input
                            type="radio"
                            name="choice"
            ...
            <a href="/profil" className='text-white hover:text-blue-700 bg-gray-300 p-4 rounded-lg shadow-lg mt-4'>Retour</a>
        </div>
    );
}
