 ...
 */
final class Version20250117132850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE traveler (id INT AUTO_INCREMENT NOT NULL, user_profile_id_id INT NOT NULL, lastname VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, birthdate DATE DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, second_name VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, dhs INT DEFAULT NULL, ktn INT DEFAULT NULL, principal TINYINT(1) NOT NULL, INDEX IDX_6841F216661EACD5 (user_profile_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
