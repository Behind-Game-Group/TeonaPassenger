 ...
 */
final class Version20250111225158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shared_trip (id INT AUTO_INCREMENT NOT NULL, user_profile_id_id INT NOT NULL, email VARCHAR(255) DEFAULT NULL, is_editable TINYINT(1) NOT NULL, INDEX IDX_CCA09EA3661EACD5 (user_profile_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE traveler (id INT AUTO_INCREMENT NOT NULL, user_profile_id_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, birthdate DATE DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, second_name VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, dhs INT DEFAULT NULL, ktn INT DEFAULT NULL, INDEX IDX_6841F216661EACD5 (user_profile_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(180) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, apple_id VARCHAR(255) DEFAULT NULL, auth0_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, lastname VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, site VARCHAR(255) DEFAULT NULL, local_airport VARCHAR(255) DEFAULT NULL, create_time DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_time DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_D95AB4059D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
